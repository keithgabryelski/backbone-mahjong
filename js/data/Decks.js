  ...
  [
    {
      ...
      tiles: app.decks.generate_tiles([
        [ app.tiles.where({tile_category: app.tileCategories.wind}),           4, ],
        ...
        [ app.tiles.where({tile_category: app.tileCategories.flower}),         1, ],
        [ app.tiles.where({tile_category: app.tileCategories.season}),         1, ],
      ])
    },
  ]
);
